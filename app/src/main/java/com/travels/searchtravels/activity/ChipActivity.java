        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    AviasalesApi.getTicketPrice(city, new AviasalesApi.OnTicketPriceListener() {
                        @Override
                        public void onSuccess(final Integer price, String countryName, String code) {
                            Handler handler = new Handler(getMainLooper());

                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    airticketTV.setText("от " + price + "\u20BD");
